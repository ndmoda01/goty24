...
//INPUT_MAX_PLAYERS macro needs to be set to allow for more players (currently 2 max)
InputPartySetParams(INPUT_VERB.PAUSE,1,numb_players_max,false,undefined);
